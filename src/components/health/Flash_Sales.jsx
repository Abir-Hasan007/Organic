...
import { faHeart,faRetweet,faShoppingCart,faShoppingBag,faPhone} from "@fortawesome/free-solid-svg-icons"
            ...
            <div class="row">
                <div class="col">
                    <div class="flash__item">
                        <div class="flash__item__pic set-bg">
                        <img src= 'https://chaldn.com/_mpimage/olympic-lexus-vegetable-crackers-biscuits-216-gm?src=https%3A%2F%2Feggyolk.chaldal.com%2Fapi%2FPicture%2FRaw%3FpictureId%3D115564&q=best&v=1&m=400&webp=1'  />
                            <ul class="flash__item__pic__hover">
                                <p>Add to </p>
                                <p>Shopping</p>
                                <p>Bag</p>
                                <li><a href="#"><FontAwesomeIcon icon={faHeart} className="icon"/> </a></li>
                                <li><a href="#"><FontAwesomeIcon icon={faRetweet} className="icon"/> </a></li>
                                <li><a href="#"><FontAwesomeIcon icon={faShoppingCart} className="icon"/> </a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="flash__item__text">
                    <h6 style={{marginLeft : '50px'}}><a href="#">Lexus Biscuit</a></h6>
                    <span style={{marginLeft : '70px'}}>250gm</span>
                       <h5 style={{marginLeft : '70px'}}>৳ 80</h5>
