...
import './daily_deals.css'
import { Link } from 'react-router-dom';
import NavDropdown from 'react-bootstrap/NavDropdown';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome'
import { faPhone,faBars} from "@fortawesome/free-solid-svg-icons"
export default function Daily_deals({newYear}) {
            ...
            <div className="daily-deals-header">
                ...
                <div className="header-body">
                    <div className="deal-details">
                        <div className="line">
                        Get exciting deals everyday. Grab before stock runs out.
                        </div>
                        <div className="line">
                            <span>Shop over 199Tk to activate deal</span>
                        </div>
                        <div className='timer-container'>
                            <div className='todays-deal'>Today's Deal</div>
                            <div className='timer'>
                    ...
                    <div className='deal-product'>
                        <img src="https://chaldn.com/_mpimage/chaldal-basic-dishwashing-bar-300-gm-combo-pack-2-pcs?src=https%3A%2F%2Feggyolk.chaldal.com%2Fapi%2FPicture%2FRaw%3FpictureId%3D121779&q=best&v=1&m=400&webp=1" alt="" />
                        <div className='product-detail'>
                            <div className='product-name'>Chaldal Basic Dishwashing Bar 300 gm (Combo Pack) 2 pcs</div>
                   ...
                   <div className='deals-section' style={{border : '1px solid #ebebeb'}}>
                            <h2 style={{border : '1px solid #ebebeb'}}>Previous Deal :</h2>
                            {/* <div className='section-title'>Previous Deals</div> */}
                            <div className='previous-deals'>
                                <div className='product-card'>
                                    <img className = 'imgs' src="https://chaldn.com/_mpimage/chaldal-basic-dishwashing-bar-300-gm-combo-pack-2-pcs?src=https%3A%2F%2Feggyolk.chaldal.com%2Fapi%2FPicture%2FRaw%3FpictureId%3D121779&q=best&v=1&m=400&webp=1" alt="" />
                                    <div className='p-details'>
                                        <div className='p-name'>
                                        Chaldal Basic Dishwashing Bar 300 gm (Combo Pack) 2 pcs
                                        </div>
                                        <div className='p-price-unit'>
                                            <span>2 pcs</span>
                                            <span>৳45</span>
                                        </div>
                                    </div>
